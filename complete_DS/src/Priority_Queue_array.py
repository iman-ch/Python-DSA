...
class Priority_Queue:
    ...
    def combine(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        # interlace the values from the two source queues
        while not source1.is_empty() and not source2.is_empty():
            # check which value has higher priority and append it to self._values
            if source1.peek() <= source2.peek():
                self._values.append(source1._values.pop(0))
            else:
                self._values.append(source2._values.pop(0))

        # append any remaining values from source1 and source2 to self._values
