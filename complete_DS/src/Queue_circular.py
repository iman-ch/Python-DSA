...
class Queue:
    ...
    def __eq__(self, target):
        ...
        if self._count == target._count: 
            ...
            while count < self._count and self._values[i] == target._values[j]:
    ...
    def insert(self, value):
        ...
        # put value to insert at end of queue, increase queue count
        self._values[self._rear] = deepcopy(value)
        self._count += 1
        
        # check if items are reaching capacity
        if self._count == self._capacity: # full
            self._rear = None
    ...
    def remove(self):
        ...
        # value to pop is at the index of self._front
        value = self._values[self._front]
        
        # after value is stored, cannot pop from queue, so you have to set the front value to empty slot or "None"
